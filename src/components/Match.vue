  ...
  <div>
    <el-row style="font-size:2rem; font-weight:bold" class="match-summary"> 
      <el-col :span="10" style="text-align:right; color:#66BB6A">
        <h3 style="filter: drop-shadow(0 0 5px #ff4c4c)">Radiant {{ matchSummary.radiant_score }} {{matchSummary.radiant_win ? 'Victory' : ''}}</h3>
      </el-col>
       <el-col :span="4" style="text-align:center; color:#fff">
          <h3>{{ duration }}</h3>
      </el-col>
       <el-col :span="10" style="text-align:left; color:#FF4C4C">
         <h3 style="filter:drop-shadow(0 0 5px green); ">Dire {{ matchSummary.dire_score }} {{matchSummary.radiant_win ? '' : '(Victory)'}}</h3>
      </el-col>
    </el-row>
    <el-row>
    ...
    <MatchDetailTable :players="radiantPlayers"></MatchDetailTable>
    <el-row>
      <el-col :span="24" class="match-detail">
    ...
    <MatchDetailTable :players="direPlayers"></MatchDetailTable>
  </div>
</template>
...
export default {
    ...
    computed:{
        matchCache(){
          return this.$store.state.matchCache;
        },
        duration(){
          let seconds = this.matchSummary.duration
    ...
    methods: {
      getMatchData(){
        let matchCache= this.matchCache[this.matchId];
        if(!matchCache){
          let matchData = {};
          ...
          this.matchSummary = matchCache.matchSummary;
          this.radiantPlayers = matchCache.radiantPlayers;
          this.direPlayers = matchCache.direPlayers;
        } 
      },
      ...
      updateMatchCache(matchId,matchSummary,radiantPlayers,direPlayers){
        this.$store.dispatch('updateMatchCache', this.generatePayload(matchId,matchSummary,radiantPlayers,direPlayers));
      }
    }
  }
</script>
